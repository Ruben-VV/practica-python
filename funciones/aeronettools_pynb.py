...
def extract_aeronet_data(inputfile):
    ...
    for name, group in df_grouped:
        ...
        df_filter = perc_hours_with_data(group, 0.75) # horas seguidas sin nubes
